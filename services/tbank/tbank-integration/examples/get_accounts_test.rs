...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("🏦 Получение списка банковских счетов T-Bank");
    println!("===========================================");
    ...
    println!("\n💡 Рекомендации:");
    println!("================");
    println!("1. Используйте один из полученных номеров счетов для создания исходящих счетов");
    println!("2. Убедитесь, что счет активен и имеет статус 'ACTIVE' или аналогичный");
    println!("3. Для рублевых операций используйте рублевые счета (RUB)");
