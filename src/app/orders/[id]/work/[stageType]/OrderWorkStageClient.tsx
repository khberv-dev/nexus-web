    ...
    stage ? (
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        <div>
          ...
          <div style={{ fontSize: "0.82rem", lineHeight: 1.55, color: "var(--dash-text)" }}>{stagePurpose(stage.type)}</div>
        </div>
        <div>
          <div style={{ fontSize: "0.72rem", fontWeight: 600, color: "var(--dash-text2)", marginBottom: 6, letterSpacing: "0.02em" }}>
            В этом статусе
            ...
            <div className="dash-content">
                ...
                <div className="dash-surface-card dash-brief-card" style={{ overflow: "hidden" }}>
                  ...
                  {stage ? (
                    <div className="dash-brief-row" style={{ borderBottom: "1px solid var(--dash-border)" }}>
                      ...
                      <span className="dash-brief-value" style={{ color: STAGE_STATUS[stage.status].color }}>
                        {stageStatusLabel}
                      </span>
                    </div>
                  ) : null}
                ...
                {stage?.rulesS3Key ? (
                  <div className="dash-surface-card" style={{ marginTop: 12, padding: 0, overflow: "hidden" }}>
                    <details>
                      ...
                      >
                        <span style={{ display: "inline-flex", alignItems: "center", gap: 8, fontSize: "0.82rem", fontWeight: 700, color: "var(--dash-text)" }}>
                      ...
                      <div style={{ padding: "10px 12px" }}>
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          style={{ display: "inline-flex", alignItems: "center", gap: 6, textDecoration: "none", color: "var(--dash-accent)", fontSize: "0.82rem", fontWeight: 600 }}
                        >
                          <i className="bx bx-file" />
                          Скачать PDF с правилами
                        </a>
                        <div style={{ marginTop: 6, fontSize: "0.74rem", color: "var(--dash-muted)", lineHeight: 1.45 }}>
                          Рекомендуем посмотреть перед согласованием — там описаны формат и состав материалов по этапу.
                        </div>
                      </div>
                    </details>
                  </div>
              ...
              <div className="dash-col2 order-work-stage-col2">
                <div className="order-work-stage-main">
                  <div className="dash-list-heading-wrap" style={{ marginBottom: 12, display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
                    <h2 className="dash-list-heading">Ход работ</h2>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
                      <Link href={`/orders/${order.id}`} className="dash-header__btn dash-header__btn--primary">
                        ...
                        {stage.status === "APPROVED" ? (
                          ...
                          >
                            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                              <i className="bx bx-check-circle" style={{ color: "var(--dash-success)", fontSize: "1.15rem" }} aria-hidden />
                              <div style={{ minWidth: 0 }}>
                                <div style={{ fontWeight: 700, fontSize: "0.86rem", color: "var(--dash-success)" }}>Этап принят</div>
                                <div style={{ fontSize: "0.76rem", color: "var(--dash-muted)" }}>
