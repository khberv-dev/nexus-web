  ...
  return (
    <div style={{ marginTop: "1rem", paddingTop: "1rem", borderTop: "1px solid var(--dash-border)" }}>
      {!showRevision ? (
        ...
        <div>
          <p style={{ fontSize: "0.82rem", fontWeight: 600, color: "var(--dash-text)", marginBottom: "0.5rem" }}>
            Что нужно доработать?
          </p>
          <p style={{ fontSize: "0.72rem", color: "var(--dash-muted)", margin: "0 0 0.75rem", lineHeight: 1.45 }}>
            Опишите замечания в чате — дизайнер получит уведомление. Когда закончите, отправьте этап на доработку.
          </p>
          <button
            type="button"
