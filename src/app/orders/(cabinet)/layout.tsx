...
/**
 * Общая оболочка разделов кабинета заказчика (/orders, /orders/payments, /orders/settings):
 * шапка, герой, сайдбар и экскурсия живут здесь, разделы — страницы в этой группе.
 */
export default async function ClientCabinetLayout({children}: { children: ReactNode }) {
