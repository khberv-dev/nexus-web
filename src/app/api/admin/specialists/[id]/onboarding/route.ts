...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  await audit(dbUser?.id ?? null, isRejectAction ? "specialist_rejected" : "specialist_advanced", "User", id, { onboardingStatus: { from: profile.onboardingStatus, to: newStatus }, action: { to: action } })
