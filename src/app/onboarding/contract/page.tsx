        ...
        {loading ? (
          ...
          <>
            <AppCard style={{ marginBottom: "1.25rem" }}>
              <div style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.7rem", letterSpacing: "0.06em", textTransform: "uppercase", marginBottom: 8 }}>
                Статус
              </div>
              <div style={{ color: "#f4f4f4", fontWeight: 600, fontSize: "1rem", marginBottom: 8 }}>{hint.title}</div>
              <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.88rem", margin: 0, lineHeight: 1.5 }}>{hint.detail}</p>
              {state.number && (
                <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.82rem", marginTop: 12, marginBottom: 0 }}>
            ...
            {state.hasFile && (
              <AppCard style={{ marginBottom: "1.25rem" }}>
                <div style={{ color: "#f4f4f4", fontWeight: 500, marginBottom: 12 }}>Исходный PDF договора</div>
                <button
                  type="button"
            ...
            {state.hasSignedFile && (
              <AppCard style={{ marginBottom: "1.25rem" }}>
                <div style={{ color: "#f4f4f4", fontWeight: 500, marginBottom: 12 }}>Ваш подписанный PDF</div>
                <button
                  type="button"
            ...
            {state.status === "AWAITING_SIGNATURE" && state.hasFile && (
              <AppCard style={{ marginBottom: "1.25rem" }}>
                <label style={{ display: "block", color: "rgba(255,255,255,0.45)", fontSize: "0.78rem", fontWeight: 600, marginBottom: 8 }}>
                  Оператор ЭДО
                </label>
                <input
                  type="text"
                  ...
                  maxLength={500}
                />
                <label style={{ display: "block", color: "rgba(255,255,255,0.45)", fontSize: "0.78rem", fontWeight: 600, marginTop: 16, marginBottom: 8 }}>
                  Подписанный PDF
                </label>
                <input
                  type="file"
