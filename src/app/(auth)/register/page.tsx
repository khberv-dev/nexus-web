                ...
                <AppCard>
                    {sent ? (
                        <p style={{color: "rgba(255,255,255,0.85)", fontSize: "0.95rem", lineHeight: 1.55, margin: 0}}>
                            Ссылка отправлена на <strong
                            style={{color: "#fff"}}>{form.email?.trim().toLowerCase()}</strong>
                        </p>
                    ) : (
                        <form onSubmit={handleSubmit}
                            ...
                            {FIELDS.map(field => (
                                <div key={field.name} style={{display: "flex", flexDirection: "column", gap: "0.4rem"}}>
                                    <label
                                        ...
                                        <span style={{color: "rgba(255,100,100,0.7)", marginLeft: 3}}>*</span>}
                                    </label>
                                    <input
                                        type={field.type}
                                ...
                                <div style={{display: "flex", flexWrap: "wrap", gap: "0.4em"}}>
                                    {POSITION_CHIPS.map(chip => {
                                        ...
                                        return (
                                            ...
                                            >
                                                {active &&
                                                    <span style={{marginRight: "0.3em", fontSize: "0.65rem"}}>✓</span>}
                                                {chip}
                                            </button>
                                        )
                                    })}
                            ...
                            <button
                                ...
                                onMouseEnter={e => {
                                    if (!loading) (e.currentTarget.style.background = "rgba(255,255,255,0.13)")
                                }}
                                onMouseLeave={e => {
