    ...
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 280px", gap: 20, alignItems: "start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
          ...
          <AdminAccordion icon="bx-clipboard" title="Анкета специалиста" badge={fd ? `${Object.values(fd).filter(Boolean).length} полей` : "не заполнена"} defaultOpen>
        ...
        <div style={{ position: "sticky", top: 24, border: "1px solid var(--adm-sidebar-border, rgba(0,0,0,0.08))", borderRadius: 8, background: "var(--adm-sidebar)", padding: 14 }}>
          ...
          <div style={{ maxHeight: "70vh", overflowY: "auto", scrollbarWidth: "thin", scrollbarColor: "rgba(255,255,255,0.15) transparent" }}>
