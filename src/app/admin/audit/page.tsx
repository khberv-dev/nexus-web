                ...
                <div className="sp-card" style={{marginBottom: 16}}>
                    <div className="sp-card-bd"
                        ...
                        <div>
                            ...
                            <select value={filter} onChange={e => setFilter(e.target.value)} className="sp-input"
                                    style={{minWidth: 160}}>
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Email, ID…" value={search}
                                   onChange={e => setSearch(e.target.value)} className="sp-input"
                                   style={{minWidth: 220}}/>
                        </div>
                        <div>
