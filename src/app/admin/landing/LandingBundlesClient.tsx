                        ...
                        <div className="card">
                            <div className="table-responsive">
                                <table className="table table-hover mb-0">
                                    ...
                                    <tbody>
                                    {bundles.map(b => (
                                        <tr key={b.id} role="button" tabIndex={0} onClick={() => {
                                            setSelected(b.id);
                                            setRejectReason("")
                                        }}
                                            onKeyDown={(e) => {
                                            ...
                                            <td style={{
                                                fontSize: "0.75rem",
                                                whiteSpace: "nowrap"
                                            }}>{new Date(b.updatedAt).toLocaleDateString("ru-RU")}</td>
                                        </tr>
                                    ))}
                                    </tbody>
                                </table>
                    ...
                    {selectedBundle.user.name ?? selectedBundle.user.email}
                                        ...
                                        <div className="col-8">
                                            ...
                                            <div style={{
                                                ...
                                                {selectedBundle.workFileId && previews[selectedBundle.workFileId]
                                                    ? <ImageLightbox src={previews[selectedBundle.workFileId]}
                                                                     alt="Интерьер"><img
                                                        src={previews[selectedBundle.workFileId]} alt="" style={{
                                                        width: "100%",
                                                        height: "100%",
                                                        objectFit: "cover",
                                                        objectPosition: selectedBundle.workPos ?? "center center"
                                                    }}/></ImageLightbox>
                                                    : <div
                                                        className="d-flex align-items-center justify-content-center h-100 text-muted">
                            ...
                            {selectedBundle.workPos}
                                    ...
                                    {selectedBundle.videoFileId && (
                                        <div className="mb-3">
                                            ...
                                            {previews[selectedBundle.videoFileId]
                                                ? <video src={previews[selectedBundle.videoFileId]} controls playsInline
                                                         preload="metadata"
                                    ...
                                    {selectedBundle.items.length > 0 && (
                                        <div className="mb-3">
                                            <div style={{
                                                ...
                                                color: "var(--adm-muted)",
                                                marginBottom: 4
                                            }}>ПОРТФОЛИО ({selectedBundle.items.length})
                                            </div>
                                                    ...
                                                    <div key={item.id} style={{
                                                        ...
                                                        {previews[item.fileId]
                                                            ? <ImageLightbox src={previews[item.fileId]}
                                                                             alt="Портфолио"><img
                                                                src={previews[item.fileId]} alt="" style={{
                                                                width: "100%",
                                                                height: "100%",
                                                                objectFit: "cover"
                                                            }}/></ImageLightbox>
                                    ...
                                    <div className="mb-3" style={{fontSize: "0.8rem"}}>
                                        ...
                                        {selectedBundle.about &&
                                            <div><span className="text-muted">О себе:</span> {selectedBundle.about}
                                            </div>}
                                    </div>
