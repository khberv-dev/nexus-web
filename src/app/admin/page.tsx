            ...
            <div className="row g-3 mb-4">
                {([
                    ...
                    },
                    {
                        ...
                        sub: `${pendingSpecialists} ожидают модерации`,
                        icon: "bx-user-check",
                        color: "info"
                    },
                    ...
                    {
                        label: "На удержании",
                        value: `${heldTotal.toLocaleString("ru-RU")} руб.`,
                        sub: `${heldPayments} платежей`,
                        icon: "bx-money",
                        color: "success"
                    },
                ] as const).map(s => (
