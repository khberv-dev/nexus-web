                ...
                <div className="grid gap-4">
                    <Card>
                        <CardHeader className="pb-3">
                            ...
                            <CardDescription>Файл будет сохранён в S3 и станет доступен по ссылке
                                скачивания.</CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-3">
                            {stageTemplate ? (
                                ...
                                <Alert>
                                    ...
                                    <AlertDescription>Для этого этапа нет подготовленного документа. Используйте
                                        загрузку файла ниже.</AlertDescription>
                                </Alert>
                            )}
                            ...
                            <div
                                ...
                                <div className="min-w-0">
                                    ...
                                    <div className="text-sm text-muted-foreground">Заменит текущий прикреплённый файл.
                                    </div>
                                </div>
                                <input
                                    ref={fileInputRef}
                        ...
                        <CardFooter className="justify-between gap-3">
                            <div className="text-sm text-muted-foreground">
                                Ссылка для дизайнера: <span
                                className="font-medium text-foreground">`/api/stages/{stage.id}/rules`</span>
                            </div>
                        </CardFooter>
                    </Card>
                    ...
                    <Card>
                        <CardHeader className="pb-3">
                            ...
                            <CardDescription>Отправит сообщение дизайнеру и сохранит статус «у дизайнера» для этого
                                шага.</CardDescription>
                        </CardHeader>
                        <CardContent>
