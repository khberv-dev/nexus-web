    ...
    <div className="sp-card">
      ...
      <div className="sp-card-bd" style={{ padding: 0 }}>
        ...
        {(() => {
          ...
          return (
            <div key={stage.id} id={`stage-${stage.id}`} className={`sp-stage-detail-panel${isMod ? " sp-stage-detail-panel--mod" : ""}`}>
              <div className="sp-stage-detail-panel-hd">
                <div>
                  <span style={{ fontWeight: 500, fontSize: "0.85rem" }}>{STAGE_LABEL[stage.type]}</span>
                  <span style={{ fontSize: "0.72rem", color: "var(--adm-muted)", marginLeft: 8 }} title="Счётчики раундов доработки">
