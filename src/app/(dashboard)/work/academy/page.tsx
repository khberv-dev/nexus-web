  ...
  return (
    <div className="dash">
      <DashTopHeader
        ...
        primaryAction={{ href: SPECIALIST_CABINET_LOGO_HREF, label: "К профилю", iconClassName: "bx bx-arrow-back" }}
      />
      <DashMainLayout sidebar={<DashSidebarNav tabs={SPECIALIST_ROUTE_TABS} activeTab="" />}>
        <Link href={SPECIALIST_CABINET_LOGO_HREF} style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: "0.78rem", color: "var(--dash-muted)", textDecoration: "none", marginBottom: 12 }}>
