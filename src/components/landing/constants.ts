...
export const FALLBACK_SLIDES: DesignerSlide[] = [
    {
        portrait: "/designer-1.jpg",
        work: "/slider-1.jpg",
        workPos: "center 40%",
        name: "Анна Соколова",
        specialty: "Минимализм · Сканди",
        sqm: 1200,
        experience: 8,
        style: "Сканди",
        has3d: true,
    ...
    {
        portrait: "/designer-2.jpg",
        work: "/slider-2.jpg",
        workPos: "center 30%",
        name: "Дмитрий Орлов",
        specialty: "Лофт · Индастриал",
        sqm: 850,
        experience: 5,
        style: "Лофт",
        has3d: true,
    ...
    {
        portrait: "/designer-3.jpg",
        work: "/slider-3.jpg",
        workPos: "center 35%",
        name: "Мария Ким",
        specialty: "Контемпо · Арт-деко",
        sqm: 2400,
        experience: 12,
        style: "Арт-деко",
        has3d: true,
    ...
    {
        portrait: "/designer-4.jpg",
        work: "/slider-4.jpg",
        workPos: "center 25%",
        name: "Игорь Петров",
        specialty: "Классика · Неоклассика",
        sqm: 600,
        experience: 3,
        style: "Неоклассика",
        has3d: false,
