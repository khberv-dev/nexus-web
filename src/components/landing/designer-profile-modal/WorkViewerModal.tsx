  ...
  return (
    <Modal open={open} onClose={onClose} maxWidth={1100} theme="dark">
      <div style={{ position: "relative", background: "#0b0b10" }}>
        ...
        <div style={{ position: "relative", display: "flex", alignItems: "center", justifyContent: "center", height: "min(78vh, 720px)", padding: 12 }}>
          {activeSrc && (
          ...
          {works.length > 1 && (
            <>
              <button type="button" aria-label="Предыдущая работа" onClick={onPrev} style={{ ...navBtnStyle, left: 10 }}>
                ‹
              </button>
              <button type="button" aria-label="Следующая работа" onClick={onNext} style={{ ...navBtnStyle, right: 10 }}>
                ›
              </button>
            </>
          )}
