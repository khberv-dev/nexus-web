      ...
      <div className="dash-drawer-root" role="presentation">
        ...
        <aside className="dash-drawer" aria-modal aria-label="Меню кабинета">
          <div className="dash-drawer__top">
            ...
            <button type="button" className="dash-drawer__close" onClick={() => setDrawerOpen(false)} aria-label="Закрыть">
              <i className="bx bx-x" />
            </button>
          </div>
            ...
            {primaryAction ? (
              primaryAction.disabled ? (
                ...
                <Link
                  ...
                  onClick={() => setDrawerOpen(false)}
                >
                  {primaryAction.iconClassName ? <i className={primaryAction.iconClassName} aria-hidden /> : null}
                  <span>{primaryAction.label}</span>
                </Link>
              )
            ) : null}
            <Link href="/" className="dash-drawer__link dash-drawer__link--muted" onClick={() => setDrawerOpen(false)}>
            ...
            <span
              ...
              style={
                statusChip.color || statusChip.background
                  ? { color: statusChip.color ?? undefined, background: statusChip.background ?? undefined }
                  : undefined
              }
            >
              {statusChip.label}
