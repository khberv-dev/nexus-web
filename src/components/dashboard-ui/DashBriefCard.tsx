        ...
        <span style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          {imageLinks.map(link => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              style={{ display: "inline-flex", borderRadius: 8, overflow: "hidden", border: "1px solid var(--dash-border)" }}
              title="Открыть изображение"
            >
              <img src={link} alt="brief reference" style={{ width: 88, height: 64, objectFit: "cover", display: "block" }} />
            </a>
          ))}
        </span>
      ) : null}
