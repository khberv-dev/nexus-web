                ...
                >
                  ...
                  <div className="spec-dashboard__urgent-content">
                    ...
                    <div className="spec-dashboard__urgent-meta">
                      ...
                      <span className="spec-dashboard__urgent-status" style={{ color: STAGE_STATUS_LABELS[item.stageStatus]?.color }}>
                  ...
                  {recentOrders.map((order) => {
                    ...
                    return (
                      <tr key={order.id}>
                        ...
                        <td>
                          <span className={`spec-dashboard__status spec-dashboard__status--${order.status.toLowerCase()}`}>
                        ...
                        <td>
                          <div className="spec-dashboard__progress">
                            <div className="spec-dashboard__progress-bar">
                              <div className="spec-dashboard__progress-fill" style={{ width: `${pct}%` }} />
                            </div>
