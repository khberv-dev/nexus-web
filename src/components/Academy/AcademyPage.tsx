    ...
    return (
        <div className="course-rating">
            {[1, 2, 3, 4, 5].map(s => <span key={s}
                                            className={`star${s <= Math.round(rating) ? " filled" : ""}`}>★</span>)}
        </div>
    )
}
        ...
        <div className="academy-page">
            ...
            <div className="academy-hero">
                ...
                <div className="hero-center">
                    ...
                    <p>Развивайте навыки с надежными онлайн-курсами по дизайну интерьера, визуализации, работе с
                        клиентами и документации.</p>
                    <div className="hero-search">
                        <input type="text" placeholder="Найти курс" value={search} onChange={e => {
                ...
                <div className="courses-header">
                    ...
                    <div className="courses-controls">
                        ...
                        <label className="toggle-label">
                            ...
                            <div className={`toggle${hideCompleted ? " on" : ""}`} role="switch"
                                 aria-checked={hideCompleted} tabIndex={0} onClick={() => setHideCompleted(v => !v)}
                                 onKeyDown={(e) => {
