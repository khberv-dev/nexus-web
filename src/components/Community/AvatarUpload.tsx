  ...
  const handleApply = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/files", {
        ...
        body: JSON.stringify({ filename, mimeType: "image/jpeg", size: blob.size, category: "AVATAR", title: "avatar" }),
      })
  ...
  return (
    <div>
      ...
      <div className="d-flex align-items-center gap-3 mb-3">
        ...
        <input ref={inputRef} type="file" accept="image/jpeg,image/png" className="d-none" onChange={onFileChange} />
      </div>
      ...
      {srcUrl && (
        <div style={{
          ...
          <div className="d-flex gap-2 mt-3">
            <button className="btn btn-primary btn-sm" onClick={handleApply} disabled={uploading || !completedCrop}>
