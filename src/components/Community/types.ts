...
export type OrderWithRelations = {
  ...
  stages: { id: string; type: StageType; status: string; modRound: number; clientRound: number; act?: { id: string; signedAt: Date | null } | null }[]
}
...
export const ORDER_STATUS_MAP: Record<string, { variant: "active" | "pending" | "done" | "rejected" | "current"; label: string }> = {
...
export const ORDER_HUE: Record<string, number> = { DRAFT: 60, BRIEFING: 35, BRIEF_REVIEW: 200, ACTIVE: 247, DONE: 140, CANCELLED: 0 }

export const PAYMENT_BADGE: Record<PaymentStatus, { variant: "done" | "pending" | "current" | "rejected"; label: string }> = {
...
export const PAYMENT_HUE: Record<PaymentStatus, number> = { HELD: 200, RELEASED: 140, PENDING: 60, REFUNDED: 0, FAILED: 0 }
...
export const DISCOVER_HUES = [{ h1: 247, h2: 282 }, { h1: 200, h2: 230 }, { h1: 120, h2: 160 }, { h1: 0, h2: 35 }, { h1: 280, h2: 310 }]
