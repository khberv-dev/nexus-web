  ...
  return (
    <section className="mt-4 pt-3" style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }}>
      <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-2">
        <div>
          <h6 className="mb-0 small fw-semibold text-uppercase" style={{ letterSpacing: "0.06em", color: "rgba(255,255,255,0.5)" }}>
            Материалы проекта
          </h6>
          <p className="small mb-0 text-muted" style={{ lineHeight: 1.45 }}>
            Сюда — файлы <strong>на весь проект</strong> (одна спецификация, пакет PDF на все кадры и т.п.). Это не то же самое, что вложения{" "}
            <strong>внутри работы</strong> (их добавляют в окне «Новая работа» / «Изменить» у плитки). Работы можно оставить только с фото и рендерами.
          </p>
        </div>
        <div>
          <input
      ...
      {loading ? (
        ...
        <p className="small text-muted mb-0" style={{ lineHeight: 1.5 }}>
          Пока нет общих материалов. Кнопка «Добавить в проект» — файлы для <strong>всей папки</strong>. Нужны файлы к одной работе — откройте плитку
          работы и «Изменить».
        </p>
      ) : (
        <div
        ...
        >
          {rows.map((r) => (
            ...
            >
              ...
              <span className="small text-truncate" style={{ color: "rgba(255,255,255,0.85)" }} title={r.file.filename}>
              ...
              <div className="d-flex gap-1 flex-wrap">
                ...
                <button type="button" className="btn btn-sm btn-outline-danger" onClick={() => void remove(r.id)} title="Убрать из проекта">
