      ...
      <details open={defaultOpen}>
        ...
        <div style={{ padding: "10px 12px", fontSize: "0.82rem", color: "var(--dash-text2)", lineHeight: 1.55 }}>
          <div style={{ marginBottom: 10 }}>
            ...
            <div>
              Проект идёт по этапам (концепция → планировка → визуализация → документация → спецификация). Когда дизайнер сдаёт этап, он уходит на проверку, затем появится статус{" "}
              <strong style={{ color: "var(--dash-text)" }}>«Ожидает вашего решения»</strong> — тогда можно принять этап или отправить на доработку.
            </div>
          </div>
          ...
          <div style={{ marginBottom: 10 }}>
            ...
            <div>
              Замечания и вопросы пишите в чате с администратором — он передаст их дизайнеру и поможет согласовать детали. После отправки на доработку дизайнер загрузит обновлённые материалы, и этап
          ...
          <div>
            ...
            <div>
              Все счета и история оплат — в разделе <strong style={{ color: "var(--dash-text)" }}>«Оплата»</strong> (кнопка ниже). Если потребуется доплата за дополнительные правки, система покажет
