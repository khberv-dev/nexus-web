              ...
              <div style={{ display: "flex", flexDirection: "column" as const, gap: "0.75rem" }}>
                {[1, 2, 3].map(i => (
                  <div key={i} style={{
                    ...
                    <div style={{ background: "rgba(32,29,29,0.07)", borderRadius: 4, height: 9, width: "35%", marginBottom: 10 }} />
                    <div style={{ background: "rgba(32,29,29,0.05)", borderRadius: 4, height: 8, width: "80%", marginBottom: 8 }} />
                    <div style={{ background: "rgba(32,29,29,0.04)", borderRadius: 4, height: 8, width: "60%" }} />
                  </div>
                ))}
                <p style={{ color: "rgba(32,29,29,0.3)", fontSize: "0.78rem", textAlign: "center", margin: "0.5rem 0 0" }}>
                  Анализирую бриф…
                </p>
              </div>
            )}
            ...
            {!loading && !error && suggestions.map((s, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p style={{ color: "#201d1d", fontSize: "0.875rem", fontWeight: 600, margin: "0 0 0.3em" }}>
                    {s.tip}
                  </p>
                  <p style={{ color: "rgba(32,29,29,0.5)", fontSize: "0.8rem", margin: "0 0 0.75em", lineHeight: 1.5 }}>
                    {s.reason}
                  </p>
                  <div style={{
                    ...
                    <p style={{ color: "rgba(32,29,29,0.6)", fontSize: "0.8rem", fontStyle: "italic", margin: 0, lineHeight: 1.5 }}>
                      «{s.example}»
                    </p>
                  </div>
                  <div style={{ display: "flex", justifyContent: "flex-end" }}>
                    {isApplied ? (
                      ...
                      <button
                        ...
                        onMouseEnter={e => { e.currentTarget.style.background = "rgba(32,29,29,0.1)" }}
                        onMouseLeave={e => { e.currentTarget.style.background = "rgba(32,29,29,0.06)" }}
                      >
                        Применить →
                      </button>
                    ) : null}
          ...
          {!loading && suggestions.length > 0 && (
            <div style={{
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.background = "rgba(32,29,29,0.08)" }}
                onMouseLeave={e => { e.currentTarget.style.background = "rgba(32,29,29,0.04)" }}
              >
                ↺ Обновить подсказки
              </button>
            </div>
