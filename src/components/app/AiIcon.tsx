...
/**
 * Иконка ИИ-функций (звёзды, svgrepo.com/show/532294/stars).
 * Инлайн-SVG: цвет берётся из currentColor, размер по умолчанию — 1em, как у шрифтовых иконок.
 */
export function AiIcon({size = "1em", style, className}: {
    size?: number | string
    style?: CSSProperties
    className?: string
}) {
