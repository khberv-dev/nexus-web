...
import type { ContractPanelProps, ContractFileLinkProps } from "./types"
      ...
      <div className="sp-card-bd">
        ...
        >
          ...
          {contract.specialistSignedS3Key && (
            ...
            >
              <ContractFileLink contractId={contract.id} s3Key={contract.specialistSignedS3Key} label="Подпись дизайнера" />
            </div>
          )}
